...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2><a href="../View/InsertCategory.View.php"><button data-toggle="tooltip" type="button" class="btn btn-primary" title="Adicionar categoria"><i class="fa fa-plus-square"></i></button></a>Categorias cadastradas</h2>
